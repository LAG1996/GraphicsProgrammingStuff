...
int main()
{
	...
	Shader shader("rigged_ambient.glsl", "fragShader.glsl");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(shader.Program, "directional_light.direction"), -0.2f, -1.0f, -0.3f);
		...
		character.Draw(shader, glm::vec3(0.3f, 0.3f, 0.3f), 2.0f, deltaTime);
